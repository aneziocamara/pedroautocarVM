...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    private void pesquisar_cliente() {
        String sql = "select idcli as Id, nomecli as Nome, fonecli as Fone, modelo as Veículo, Cor from tbclientes where nomecli like ?";
        try {
    ...
    private void emitir_os() {
        String sql = "insert into tbos(tipo, situacao, defeito, servico, mecanico, valor, idcli) values(?,?,?,?,?,?,?)";
        try {
            pst = conexao.prepareStatement(sql);
            ...
            if (txtCliId.getText().isEmpty() || txtOsDef.getText().isEmpty()) {
    ...
    private void pesquisar_os() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txtOsMec.setText(rs.getString(7));
    ...
    private void alterar_os() {
        String sql = "update tbos set tipo = ?, situacao = ?, defeito = ?, servico = ?, mecanico = ?, valor = ? where os = ?";
    ...
    private void initComponents() {
        ...
        cboOsSit.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Aguardando aprovação", "Na linha de manutenção", "Veículo pronto", "Orçamento REPROVADO", "Aguardando peças", "Retorno", " ", " ", " " }));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(txtOsMec, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void rbtOrcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtOrcActionPerformed
        // atribuindo um texto à variável tipo se o radiobutton for selecionado
        tipo = "orçamento";
